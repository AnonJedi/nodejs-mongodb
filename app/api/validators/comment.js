...
module.exports.validateTogglePostLikeData = data => {
  const parsedData = {
    err: {}
  };
  ...
  if (data.userId != data.authorizedUserId) {
    parsedData.err.authorizedUserId = 'User cannot like comment as another user';
  }
  parsedData.userId = data.userId;
